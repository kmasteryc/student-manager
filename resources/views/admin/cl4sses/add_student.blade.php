...
@section('content')
    ...
    <form action="{!! route("admin::cl4ss::update-student", $cl4ss) !!}" method="POST" id="student-form" data-pjax>
        {!! csrf_field() !!}
        {!! method_field('PUT') !!}
        <div class="row">
            <div class="col-md-6">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-hover">
                            ...
                            @each('admin.cl4sses.row_current_student', $cur_students, 'student')
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        data-columns='[{"orderable": false},null,null,{"orderable":false}]'>
                            ...
                            @each('admin.cl4sses.row_all_student', $all_students, 'student')
                            </tbody>
                        </table>
                    </div>
                </div>
...
@section('script')
    <script>
        var api = "{!! route('admin::cl4ss::update-student', $cl4ss) !!}";
    </script>
@endsection